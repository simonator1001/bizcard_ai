...
export default function AuthDebugPage() {
  ...
  const testGoogleAuth = async () => {
    try {
      ...
      // Use the exact callback URL that Google expects based on the redirect_uri_mismatch error
      const redirectTo = 'https://rzmqepriffysavamtxzg.supabase.co/auth/v1/callback';
